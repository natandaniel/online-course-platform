...
public class CourseModule {
  ...
  void addLesson(String title, String content, boolean free) {
    if (getLessonByTitle(title).isEmpty()) lessons.add(
        new Lesson(null, title, content, free));
  }
  ...
  void swapLessons(String lessonTitle1, String lessonTitle2) {
    Optional<Lesson> optLesson1 =
        getLessonByTitle(lessonTitle1);
    Optional<Lesson> optLesson2 =
        getLessonByTitle(lessonTitle2);
  ...
  private Optional<Lesson> getLessonByTitle(
      String lessonTitle) {
