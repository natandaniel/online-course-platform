...
import org.nd.ocp.rest.api.domain.course.CourseModule;

import java.util.List;

class CourseModuleEntityMapper {

  static CourseModule toDomain(
    ...
    courseModule.getLessons()
                .addAll(entity.getLessons()
                              .stream()
                              .map(
                                  LessonEntityMapper::toDomain)
                              .toList());
    return courseModule;
  }

  static CourseModuleEntity toEntity(
      CourseModule courseModule) {
