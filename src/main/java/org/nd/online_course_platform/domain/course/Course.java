...
public class Course {
  ...
  Optional<CourseModule> createModule(String moduleTitle, String moduleDescription) {
    if (getModuleByTitle(moduleTitle).isEmpty()) {
      CourseModule courseModule = new CourseModule(null, moduleTitle, moduleDescription);
  ...
  void swapModules(String moduleTitle1, String moduleTitle2) {
    Optional<CourseModule> optModule1 = getModuleByTitle(moduleTitle1);
    Optional<CourseModule> optModule2 = getModuleByTitle(moduleTitle2);
  ...
  private Optional<CourseModule> getModuleByTitle(String moduleTitle) {
